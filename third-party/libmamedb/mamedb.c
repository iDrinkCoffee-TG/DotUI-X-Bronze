// mamedb.c
// MAME 0.37b5 (MAME2000)

#define NUMGAMES 2269
...
static const struct entry mamedb[NUMGAMES] = {
  // {"005", "005"},
  ...
  {"blstroi2", "Blasteroids (version 2)"},
  ...
  {"bowler", "Bowler - 4 Player Bowling"},
  ...
  {"cruisin", "Cruisin"},
  {"crush", "Crush Roller (set 1)"},
  {"crush2", "Crush Roller (set 2)"},
  {"crush3", "Crush Roller (set 3)"},
  ...
  {"dinoj", "Cadillacs and Dinosaurs (Japan)"},
  ...
  {"kof98", "King of Fighters '98 - The Slugfest"},
  {"konami88", "Konami '88"},
  {"konamigt", "Konami GT"},
  ...
  {"laser", "Laser"},
  {"lasso", "Lasso"},
  {"lastblad", "Last Blade, The"},
  {"lastbld2", "Last Blade 2, The"},
  {"lastduel", "Last Duel (US set 1)"},
  {"lastmiss", "Last Mission (US revision 6)"},
  {"lastmss2", "Last Mission (US revision 5)"},
  ...
  {"legofair", "Legend of Air Cavalry, The ~ Koukuu Kihei Monogatari"},
  {"leprechn", "Leprechaun"},
  ...
  {"pipibibi", "Pipi & Bibis / Whoopee (Japan) [bootleg ?]"},
  ...
  {"powerins", "Power Instinct (USA) [bootleg]"},
  ...
  {"qcrayon2", "Quiz Crayon Shinchan Orato Asobo (Japan)"},
  {"qix", "Qix (set 1)"},
  ...
  {"robby", "Robby Roto"},
  {"roboarmy", "Robo Army"},
  {"robocop", "Robocop (World revision 3)"},
  ...
  {"slammast", "Saturday Night Slam Masters (World)"},
  ...
  {"sqbert", "Super Q*bert - Faster, Harder, More Challenging (prototype)"},
...
char* mamedb_en(char* name) {
  unsigned int i;
  unsigned int x = 0;
  for (i = 0; i < NUMGAMES; i++) {
     if (name[x] > mamedb[i].a[x]) continue;
     else if (name[x] == 0 || name[x] < mamedb[i].a[x]) break;
     else while (name[x] == mamedb[i].a[x]) {
       if (name[x] == 0) {
         for (x = 0; mamedb[i].b[x]; x++) {
           name[x] = mamedb[i].b[x];
         }
         name[x] = 0;
         return name;
